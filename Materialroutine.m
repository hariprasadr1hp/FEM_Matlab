...
% - params : material parameters = (E,nu,syield)
...
yieldstress=params(3); %yield stress
...
%check plasticity:
if (stress_eq<yieldstress) %elastic case:
    ...
    scaleparam=yieldstress/stress_eq; %scaling parameter for stress deviator
